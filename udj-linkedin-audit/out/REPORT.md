...
## 2. Profiles (from export headers)
...
## 3. Window aggregates (single comparison table)
...
## 4. One subsection per peer (same structure for everyone)
...
1. [Apr 17, 2026 — 234 comments, 4682 rx](https://www.linkedin.com/feed/update/urn:li:activity:7444024008750239744)
   - Everyone wants to use fancy AI tools. Fewer wanna do Data Analysis. No one wants to clean Data. AI is not magic. If your data is bad, your output will be bad. It's like: Garbage in --> Garbage out. My take is that EVERYONE is obsessing over AI But they’re skipping the foundation: 𝗗𝗮𝘁𝗮 𝗤𝘂𝗮𝗹𝗶𝘁𝘆 Data A…
2. [Apr 17, 2026 — 234 comments, 4682 rx](https://www.linkedin.com/feed/update/urn:li:activity:7444020563527987200)
   - Everyone wants to use fancy AI tools. Fewer wanna do Data Analysis. No one wants to clean Data. AI is not magic. If your data is bad, your output will be bad. It's like: Garbage in --> Garbage out. My take is that EVERYONE is obsessing over AI But they’re skipping the foundation: 𝗗𝗮𝘁𝗮 𝗤𝘂𝗮𝗹𝗶𝘁𝘆 Data A…
3. [Apr 17, 2026 — 196 comments, 177 rx](https://www.linkedin.com/feed/update/urn:li:activity:7447475833880961025)
   - Data Analyst jobs hit 100+ applicants within 2 hours. I built a free AI tool that gets you there first. You’re not only competing on skill in this market. You’re also competing on timing. Because once a job gets enough applicants… HR slows down (or stops) reviewing new resumes. This is why I built 𝗝…
4. [Apr 17, 2026 — 196 comments, 177 rx](https://www.linkedin.com/feed/update/urn:li:activity:7447280557618806784)
   - Data Analyst jobs hit 100+ applicants within 2 hours. I built a free AI tool that gets you there first. You’re not only competing on skill in this market. You’re also competing on timing. Because once a job gets enough applicants… HR slows down (or stops) reviewing new resumes. This is why I built 𝗝…
5. [Apr 17, 2026 — 196 comments, 177 rx](https://www.linkedin.com/feed/update/urn:li:activity:7447274540096864259)
   - Data Analyst jobs hit 100+ applicants within 2 hours. I built a free AI tool that gets you there first. You’re not only competing on skill in this market. You’re also competing on timing. Because once a job gets enough applicants… HR slows down (or stops) reviewing new resumes. This is why I built 𝗝…

**One-line positioning (from corpus, not flattery):** Data analyst career operator with funnels (Luma/lnkd.in) and contrarian DA hooks.
...
## 7. Six-post sprint — **six different creators**, six patterns, six URLs

Sundas Khalid is **fully analyzed in §4.5** like every other peer; she is **not** the default template below. Rotate her formats in week 2 if comments plateau.
